### Optical Attentio module evaluation
"""
Optical Attention moduleのみの学習パラメータをテストデータで評価するコード
"""
...
net = OpticalAttentionModule(in_channels=3840, out_channels=3840//2, kernel_size=1)
        ...
        for video in tqdm(video_list):
            ...
            for exemplar_idx, exemplar_name in enumerate(img_eval_list):
                ...
                for query_idx in query_idx_list:  
                    ...
                    pred = net(output['query_featmap'], output['exemplear_featmap'], opflow.cuda())
                    pred = F.interpolate(pred, size=(h, w), mode='bilinear', align_corners=False)
                    
                    res_sigmoid = torch.sigmoid(pred) # 0~1
